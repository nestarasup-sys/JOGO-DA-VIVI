...
export const useGame=create<GameState>()(persist((set,get)=>({...initial,
 ...
 applyEffects:(e={})=>set(s=>{const affinity={...s.affinity};Object.entries(e.affinity||{}).forEach(([k,v])=>affinity[k]=(affinity[k]||0)+(v||0));const traits={...s.traits};Object.entries(e.traits||{}).forEach(([k,v])=>traits[k]=(traits[k]||0)+(v||0));return {affinity,traits,flags:{...s.flags,...(e.flags||{})},coins:s.coins+(e.coins||0),route:e.route??s.route,messages:[...new Set([...s.messages,...(e.messages||[])])],unlockedCG:[...new Set([...s.unlockedCG,...(e.unlockCG?[e.unlockCG]:[])])],ownedOutfits:[...new Set([...s.ownedOutfits,...(e.outfit?[e.outfit]:[])])],equipped:e.outfit??s.equipped}}),
